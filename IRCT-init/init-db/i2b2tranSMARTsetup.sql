...
set @transmartURL = 'http://i2b2transmartapp:8080/transmart';
set @resourceURL = 'http://i2b2transmartapp:8080/transmart/proxy?url=http://i2b2-wildfly:9090/i2b2/services/';
set @domain = 'i2b2demo';
set @userName = 'Demo';
